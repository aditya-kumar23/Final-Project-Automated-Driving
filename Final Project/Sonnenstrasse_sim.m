function [allData, scenario, sensors] = Sonnenstrasse_sim()
...
% Generated on: 11-Sep-2024 19:11:55
...
car_track = vehicle(scenario, ...
    'ClassID', 1, ...
    'Position', [-145.779281390627 -39.6905799195018 0], ...
    'Mesh', driving.scenario.carMesh, ...
    'Name', 'Car_track');
waypoints = [-145.779281390627 -39.6905799195018 0;
    -144.89 -52.08 0.01;
    -144.24 -60.37 0.01;
    -143.5 -66.9 0;
    -141.2 -71.5 0;
